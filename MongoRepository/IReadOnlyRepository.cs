...
namespace MongoRepository
{
            ...
            where TEntity : class, IEntity<TKey>, new()
    {
        ...
        /// </returns>
        Task<PaginatedResult<TEntity>> GetPaginatedResult(FilterDefinition<TEntity> filterDefinition = null, int? page = null, int? pageSize = null, string sortBy = null, bool isDescending = false);
